...
const ServiceCard = ({ img, title }) => {
    return (
        <Tilt tiltReverse={true} gyroscope={true}>
            <div data-aos="fade-up" data-aos-anchor-placement="center-bottom" className="w-[250px] bg-white p-5 rounded-[30px] text-center mb-12 border border-[#E3E3E3] shadow-[5.0px_5.0px_10.0px_rgba(0,0,0,0.20)]">
