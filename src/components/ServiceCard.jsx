...
const ServiceCard = ({ img, title }) => {
    return (
        <div className="w-[300px] bg-white p-5 rounded-[45px] text-center mb-12 border border-[#E3E3E3] shadow-[5.0px_5.0px_10.0px_rgba(0,0,0,0.20)]">
            <Image className="pb-3 border-b border-b-[#C6D6F6] h-[220px] w-full" src={img} alt="" />
